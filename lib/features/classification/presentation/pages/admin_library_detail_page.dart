...
class AdminLibraryDetailPage extends StatelessWidget {
  final LibraryItemData item;

  const AdminLibraryDetailPage({super.key, required this.item});
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Icon(Icons.admin_panel_settings, color: Colors.amber.shade800, size: 20),
                        const SizedBox(width: 8),
                        Text(
                          'Catatan Khusus Admin',
                          style: TextStyle(
